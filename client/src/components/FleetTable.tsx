  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900/60">
      <div className="border-b border-gray-200 px-4 py-3 dark:border-white/10">
        ...
        <p className="text-xs text-gray-400 dark:text-zinc-500">Live sync state per device · buffer flushes every 15 min</p>
      </div>
                ...
                <td className="px-4 py-2.5">
                  <span
                    className={`text-xs font-medium ${
                      t.buffered > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-gray-500 dark:text-zinc-400'
                    }`}
                  >
                    {t.buffered.toLocaleString()} {t.buffered === 1 ? 'record' : 'records'}
                  </span>
                </td>
                <td
